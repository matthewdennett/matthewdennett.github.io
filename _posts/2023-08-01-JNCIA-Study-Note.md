...
tags:
  ...
  - Study
  - Exam
media_subpath: /assets/img/2023-08-01/
---

I have had my CCNA for a long time now but never really though about the Juniper certification path. With juniper popping up a little more frequently in places of work and [NetworkChuck's 30 Day Cert Challenge](https://www.youtube.com/watch?v=NeIrWXIj1m4) I decided to step out of Cisco land and get my JNCIA. Here is a quick dump of my study notes that might be helpful if you're heading down the JNCIA path.

With many years of Cisco experience I didn't need to rehash the fundamentals of networking. My goal here was to learn the differences between the two vendors and enough of the Juniper way to pass the exam. If you don't have a background in networking my study notes will fall far short of everything you need to know for theJ NCIA exam. Either way, I would highly recommend you review the [exam objectives](https://www.juniper.net/us/en/training/certification/tracks/junos/jncia-junos.html) early in your study and again in the lead up to sitting the exam to ensure you haven't missed any topics.
...
- `run monitor stop` Same as Cisco `term no mon`
...
![Route Preference](Route-pref.png)
