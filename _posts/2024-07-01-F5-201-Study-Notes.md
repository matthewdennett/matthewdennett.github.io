...
tags:
  ...
  - Exam
---
Last month I started the process to my F5-201 certification by sitting the F5-101 exam. Now I have that exam out of the way, I'm getting ready for the F5-201 exam. Here's a quick dump of my study notes that might be helpful if you're heading down the [F5 certification](https://www.f5.com/learn/certification") path.
...
## Packet  filters
Packet filters enforce an access policy on incoming traffic and are enforced before Virtual Server selection.
